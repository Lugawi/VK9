...
struct RenderManager
{
	...
	void StretchRect(std::shared_ptr<RealDevice> realDevice, IDirect3DSurface9 *pSourceSurface, const RECT *pSourceRect, IDirect3DSurface9 *pDestSurface, const RECT *pDestRect, D3DTEXTUREFILTERTYPE Filter);
	void UpdateSurface(std::shared_ptr<RealDevice> realDevice, IDirect3DSurface9* pSourceSurface, const RECT* pSourceRect, IDirect3DSurface9* pDestinationSurface, const POINT* pDestinationPoint);
